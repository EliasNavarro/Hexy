...
def picture_transform(frame):
    ...
    roi =cv2.circle(roi, (97, 89),96,255,cv2.FILLED)
    ...
    bounded_Region=cv2.inRange(bounded_Region,0,60)
...
class VideoGet:
    def __init__(self):
        ...
        self.piCam.preview_configuration.main.size=(200,200)#(1280,720)
        self.piCam.preview_configuration.main.format="RGB888"
        self.piCam.preview_configuration.controls.FrameRate=40
        self.piCam.preview_configuration.align()
        self.piCam.configure("preview")
        self.piCam.start()
        self.frame=picture_transform(self.piCam.capture_array())
